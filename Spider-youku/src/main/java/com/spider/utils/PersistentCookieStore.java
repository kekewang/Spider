...
public class PersistentCookieStore implements CookieStore {
    ...
    public PersistentCookieStore() {
    	String cookieJson = readFile(PropertieUtil.class.getResource("/config/cookie.json").getPath());
    ...
    public void add(URI uri, HttpCookie cookie) {
       ...
       /* System.err.println("add函数，put方法  --uri.getHost---"+uri.getHost()+"   keySet---"+ cookies.get(uri.getHost()).keySet()+"encodeCookie   "
        ...
        saveFile(json.getBytes(), "/config/cookie.json");
    ...
    public static void saveFile(byte[] bfile, String fileName) {
		...
		File file = null;
		try {
			file = new File(PropertieUtil.class.getResource(fileName).getPath());
