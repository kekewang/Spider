...
public class SpiderConstants {
    ...
    public final static String YOUKU_URL = "url";
    public final static String YOUKU_TITLE = "title";
    public final static String YOUKU_CATEGORY = "category";
    ...
    public final static String GITHUB_README = "readme";
    public final static String GITHUB_WATCH = "watch";
